...
function setActiveTopicItem(item, options = {}) { const shouldScroll = options.scroll !== false; if (activeTopicItem) activeTopicItem.classList.remove('active'); activeTopicItem = item; activeTopicItem.classList.add('active'); if (shouldScroll) scrollActiveTopicItem(); }
